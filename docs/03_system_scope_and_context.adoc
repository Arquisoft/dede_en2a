...
|The user will create the pod and store there his/her information and also it will manage the app to ordewr products to buy.

|WebApp
|The app will display information store in the database and show it to the user. Also it will receive the information from the user using the PODs.
...
|The api will send queries to the database and convert the response received in order to send back the information in a proper way to the WebApp.
