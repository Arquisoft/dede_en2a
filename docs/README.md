...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/dede_en2a/](https://arquisoft.github.io/dede_en2a/) we need to execute `npm run deploy`.
