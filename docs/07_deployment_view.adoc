...
.Motivation
For development and testing the execution environment will be on each student's machine. But for the production phase it will be deployed in a _Dockerized_ environment hosted on Azure. Our goal is to have a correct understanding of Docker, the infrastructure over which our system will be deployed.
