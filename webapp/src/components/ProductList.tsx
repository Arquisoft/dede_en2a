...
function ProductList(props: ProductListProps) : JSX.Element{
    ...
    let product1 : Product = {code:"1234", name: "Camiseta Real Madrid Mbappe", description:"Camistea Real Madrid XL Temporada 22/23 Bastante Fake La verdad", price: 250, image:"realmadrid.jpg"};
    const [products] = useState([product, product1])
    return (
        <>
            <div>
