...
import {CartItem, NotificationType, Order, Product, User} from "./shared/shareddtypes";
...
import {amber, blue, blueGrey, deepOrange, grey, indigo, lightBlue, yellow} from "@mui/material/colors";
...
function App(): JSX.Element {
    ...
    const [mode, setMode] = React.useState<PaletteMode>(themeString(!initialTheme));
